...
if( localStorage.getItem("removeSig") != null) {
	var removeSig = localStorage.getItem("removeSig");
} else {
	localStorage.setItem("removeSig", "not-checked");
}


if( localStorage.getItem("sigTTI") != null) {
	var sigTTI = localStorage.getItem("sigTTI");
} else {
	localStorage.setItem("sigTTI", "not-checked");
}
